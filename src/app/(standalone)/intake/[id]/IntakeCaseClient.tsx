...
function toSelectedCase(c: CaseRow, caseClients: CaseClientRow[] = []): NonNullable<SelectedCase> {
  ...
  return {
    ...
    deceasedAddress: c.deceased_address, deceasedAddress2: c.deceased_address2 ?? null, deceasedRegisteredAddress: c.deceased_registered_address,
    ...
    clientAddress: cl?.address ?? null, clientAddress2: cl?.address2 ?? null, clientPostalCode: cl?.postal_code ?? null,
