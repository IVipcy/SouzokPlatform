...
export default async function TaskDetailPage({ params }: Props) {
  ...
  const [depsResult, relatedTasksResult, caseDocsResult] = await Promise.all([
    supabase
    ...
    supabase
      .from('tasks')
      .select('id, title, status, ext_data, template_key, started_by, started_at, completed_at, updated_at, started_by_member:members!tasks_started_by_fkey(id, name, avatar_color, avatar_url, primary_role)')
      .eq('case_id', caseId),
