...
export default function CaseSelectScreen({ cases, onSelect }: Props) {
  ...
  const pick = (c: CaseData) => onSelect({
    ...
    deceasedAddress: c.deceased_address, deceasedAddress2: (c as { deceased_address2?: string | null }).deceased_address2 ?? null, deceasedRegisteredAddress: c.deceased_registered_address,
    ...
    clientAddress2: (c.clients as { address2?: string | null } | null)?.address2 ?? null,
