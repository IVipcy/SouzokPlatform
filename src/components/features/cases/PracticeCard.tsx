...
//   塗るのは項目名の面（slate-100）だけ。見出しも値の面も白。区切りはセルの下線と細い縦線。
//   Step は白地に太字＋下線の見出し。
...
export function PracticeRow({ label, hint, sub, children, full = false, disabled = false, disabledNote }: {
  ...
  return (
    <div className="contents">
      <div className={`bg-slate-100 border-b border-r border-slate-200 px-3 py-2 flex flex-col justify-center text-[13px] font-medium text-gray-500 leading-snug whitespace-nowrap overflow-hidden ${dim} ${full ? 'sm:col-start-1' : ''}`}>
