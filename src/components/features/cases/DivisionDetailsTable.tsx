...
import type { DivisionDetailRow, HeirRow } from '@/types'
...
export default function DivisionDetailsTable({ caseId, details, heirs, onRefresh }: Props) {
    ...
    <div>
      <div className="overflow-x-auto">
        <table className="w-full text-[13px] border-collapse" style={{ minWidth: 820 }}>
          ...
          <tbody>
            {rows.length === 0 ? (
              <tr><td colSpan={6} className="px-3 py-6 text-center text-[13px] text-gray-400">分割内容が登録されていません</td></tr>
            ) : (
              rows.map(r => (
