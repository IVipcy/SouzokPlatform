  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      <div className="px-4 py-3 border-b border-gray-200 flex items-center gap-2">
        <h2 className="text-[13px] font-semibold text-brand-900">案件一覧</h2>
      ...
      <table className="list-table w-full border-collapse" style={{ tableLayout: 'fixed' }}>
        ...
        <thead>
          <tr>
            {HEADERS.map(h => (
              <th key={h.key} className="relative text-left px-3.5 py-2.5 text-[12px] font-bold text-gray-600 tracking-wider uppercase bg-gray-50 border-b border-gray-300">
