...
// mediation=true は調停の当事者・争点セクション（申立人/相手方=相続人選択・趣旨）を表示。
export type ProcedureTab = { tab: TabKey; gyomu: string; title: string; description?: string; court?: boolean; trust?: boolean; mediation?: boolean }
...
export const PROCEDURE_TABS: ProcedureTab[] = [
  ...
  { tab: 'mediation', gyomu: '調停手続き', title: '調停', description: '遺産分割調停の申し立て関連の作業を管理します。', court: true, mediation: true },
