...
const cellInp = 'input-flat w-full px-2.5 py-1.5 text-[14px] text-gray-800 outline-none'
...
const cellSel = 'input-flat w-full px-2.5 py-1.5 text-[14px] text-gray-800 outline-none cursor-pointer'
