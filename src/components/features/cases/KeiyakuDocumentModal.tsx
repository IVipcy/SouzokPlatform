  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        {/* 契約日（任意） */}
        <section>
          <label className="block text-xs font-semibold text-gray-700 mb-1">契約日（任意）<span className="ml-2 text-[12px] font-normal text-gray-400">未入力なら空欄（手書き）。和暦で出力</span></label>
