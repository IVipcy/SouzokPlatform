...
export default function OrderSheet({
  ...
  const allOsSections: { title: string; gate?: TabKey; node: ReactNode }[] = [
    ...
    { title: '相続人調査', gate: 'deceased', node: <DeceasedTab caseData={caseData} heirs={heirs} kosekiRequests={kosekiRequests} onRefresh={onRefresh} patchCase={patchCase} orderSheetMode contractDocuments={contractDocuments} /> },
