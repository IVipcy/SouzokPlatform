...
export function isSurveyBanActive(r: Pick<FinancialAssetRow, 'survey_prohibited_designation' | 'survey_prohibited_method' | 'survey_prohibited_end' | 'prohibition_released_at'>, todayYmd: string): boolean {
...
export function isSurveyBanReleased(r: Pick<FinancialAssetRow, 'survey_prohibited_designation' | 'survey_prohibited_method' | 'survey_prohibited_end' | 'prohibition_released_at'>, todayYmd: string): boolean {
