...
export const SERVICE_ROWS: ServiceRow[] = [
  ...
  { category: '手続き一式', gyomu: '登記', task: '相続登記の申請', owner: '自社', hint: '相続登記チームタスク。10割オーシャン' },
  { category: '手続き一式', gyomu: '登記', task: '識別情報通知の受領', owner: '自社', hint: '法務局から届く識別情報通知を受信簿に登録・権利書の製本と紐付け（事務管理）' },
  ...
  { category: '手続き一式', gyomu: '登記', task: '納品対応', owner: '自社', hint: '権利書製本完了後、事務管理担当が納品タブから戸籍等と一緒に納品' },
  ...
  { category: '遺産承継', gyomu: '登記', task: '納品対応', owner: '自社', hint: '権利書製本完了後、事務管理担当が納品' },
  ...
  { category: '登記', gyomu: '登記', task: '相続登記の申請', owner: '自社', hint: '相続登記チームタスク。オーシャン' },
  { category: '登記', gyomu: '登記', task: '識別情報通知の受領', owner: '自社', hint: '法務局から届く識別情報通知を受信簿に登録・権利書の製本と紐付け（事務管理）' },
  ...
  { category: '登記', gyomu: '登記', task: '納品対応', owner: '自社', hint: '権利書製本完了後、事務管理担当が納品タブから戸籍等と一緒に納品' },
  ...
  { category: '調停', gyomu: '調停手続き', task: '調停の申立（提出）', owner: '自社' },
  { category: '調停', gyomu: '調停手続き', task: '調停期日の対応', owner: '自社' },
  { category: '調停', gyomu: '調停手続き', task: '調停調書の受領', owner: '自社', kind: 'doc' },
  { category: '調停', gyomu: '調停手続き', task: '弁護士への引継ぎ', owner: '自社' },
  ...
  { category: '後見', gyomu: '後見手続き', task: '本人（被後見人）の財産目録の作成', owner: '自社' },
  { category: '後見', gyomu: '後見手続き', task: '後見人選任結果の受領（審判書・登記事項証明）', owner: '自社', kind: 'doc' },
  { category: '後見', gyomu: '後見手続き', task: '選任後の遺産分割協議への参加', owner: '自社' },
  ...
  { category: '執行', gyomu: '登記', task: '相続登記の申請', owner: '自社', hint: '相続登記チームタスク。10割オーシャン' },
  { category: '執行', gyomu: '登記', task: '識別情報通知の受領', owner: '自社', hint: '事務管理' },
  ...
  { category: '執行', gyomu: '登記', task: '納品対応', owner: '自社', hint: '事務管理・納品タブから納品' },
