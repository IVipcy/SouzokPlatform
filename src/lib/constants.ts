...
export const FUNERAL_COMPANIES = [
  ...
  'ひかりセレモニー', '伊藤典範', 'サポート湘南', '総本山善通寺関東別院',
  '株式会社羽根澤屋本店', '有限会社横浜典礼', '和光葬儀社', '横浜セレモ',
  'サンセット葬祭', '株式会社港南葬祭',
...
export const FUNERAL_DEFAULT_DISPLAY = ['公益社', '伊藤典範', '横浜セレモ'] as const
...
// === 検討中・不受託の理由（旧 LOST_REASONS の置換、migration 125 で導入）===
// 面談結果が「検討中」または「不受託」のとき選択。【検討】/【不受託】プレフィックス付き。
