...
export const ININJO_VARIANTS: IninjoVariant[] = [
  {
    ...
    group: '連名',
    fields: { ...STD, ...DECEASED },
    stamps: [{ law: 'gyosei', cell: 'U22' }, { law: 'shiho', cell: 'U28' }],
  },
  {
    key: 'rengo_yokin',
    label: '行・司連名（預金解約あり）',
  ...
  },
  {
    ...
    group: '連名',
    fields: { ...STD, ...DECEASED },
    stamps: [{ law: 'gyosei', cell: 'U21' }, { law: 'shiho', cell: 'U27' }],
  },
  {
    key: 'gyosei_souzoku',
    label: '行政単独（相続）',
  ...
  },
  {
    ...
    group: '連名',
    fields: { ...STD },
    stamps: [{ law: 'gyosei', cell: 'U20' }, { law: 'shiho', cell: 'U26' }],
  },
  {
    key: 'shiho_zoyo',
    label: '司法（贈与・信託）',
